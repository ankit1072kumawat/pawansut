...
const projectData: Project[] = [
  ...
  {
    id: 2,
    title: "Elegant Bungalow with Green Lawn & Private Swimming Pool",
    paragraph:
  ...
  {
    id: 3,
    title: "Elegant Villa in a Prime Location with Green Surroundings",
    paragraph:
  ...
  {
    id: 4,
    title: "Full Duplex Villa in a Prime Location with Modern Comforts",
    paragraph:
  ...
  {
    id: 5,
    title: "Full Duplex Villa in a Prime Location with Modern Living",
    paragraph:
  ...
  {
    id: 8,
    title: "Fully Furnished Full Duplex Villa in a Prime Location",
    paragraph:
  ...
  {
    id: 9,
    title: "Semi-Furnished Semi Duplex Villa in a Prime Location",
    paragraph:
      "Discover comfort and practicality with a semi-furnished semi duplex villa, offering a perfect balance of style and affordability. Located in a prime area, this home provides modern living spaces with essential furnishings, making it convenient and adaptable to your needs. An ideal choice for families seeking a functional yet elegant lifestyle.",
